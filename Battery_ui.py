...
class SimpleUploadViewer:
    ...
    def setup_ui(self):
        ...
        ttk.Label(stream_frame, text="Interval (sec):").grid(row=0, column=2, padx=(0, 5))
...
"""
    ...
    def start_streaming(self):
        ...
        try:
            ...
            self.stream_status_var.set("Streaming: Active")
    ...
    def _streaming_worker(self):
        """Worker thread for streaming and capturing frames"""
            ...
            try:
                ...
                if frame is not None:
                    ...
                    if current_time - self.last_capture_time >= self.capture_interval:
                        # Process the frame like an uploaded image
                        self._process_streamed_frame(frame)
    ...
    def _process_streamed_frame(self, frame):
        """Process a frame from the IP camera stream"""
        try:
            # Convert BGR to RGB
            ...
            temp_filename = f"streamed_frame_{timestamp}.jpg"
            ...
            # Update status
            self.root.after(0, lambda: self.stream_status_var.set(f"Captured: {temp_filename}"))
